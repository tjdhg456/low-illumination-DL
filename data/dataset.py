...
class COCODetection(Dataset):
    ...
    def __init__(self, data_dir, type='train', transform=None):
        ...
        self.target_transform = COCOAnnotationTransform(label_path=os.path.join(data_dir, 'labels.txt'))
...
def load_data(option, type='train'):
    if option.result['train']['train_type'] == 'robust':
        ...
        data_set = LOL_dataset(option.result['data']['data_dir'], transform, type)
